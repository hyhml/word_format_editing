...
TARGETS = {
    ...
    "originality_statement.heading",
    "originality_statement.body",
    "authorization_statement",
    "title_page",
    "title_page.title",
    "title_page.other",
    "title_page.en.institution_title",
    "title_page.en.title",
    "title_page.en.date",
    "title_page.en.other",
    "abstract.zh.title",
    ...
    "appendix.heading",
    "appendix.body",
    "appendix.heading.level_1",
    "appendix.heading.level_2",
    ...
    "document.print",
    "document.binding",
    "symbol.physical_quantity",
    "symbol.variable",
    "symbol.unit",
    "symbol.statistical",
    "symbol.statistical.exception",
}
...
CONDITION_FIELD_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "document.project_type": {"type": "enum", "values": {"thesis", "design"}},
    "target.exists": {"type": "boolean", "requires_target": True},
    "target.has_content": {"type": "boolean", "requires_target": True},
    "target.contains_math": {"type": "boolean", "requires_target": True},
}
...
NUMBER_FORMATS = {"arabic", "lower_roman", "upper_roman", "lower_letter", "upper_letter", "chinese", "circled_chinese"}
...
PROPERTY_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "pagination.same_page_as": {"type": "target"},
    ...
    "table.style": {"type": "enum", "values": {"three_line", "open", "grid", "custom"}},
    ...
    "object.keep_with_caption": {"type": "boolean"},
    "references.style": {"type": "string"},
    "references.hanging_indent_cm": {"type": "number", "minimum": 0, "maximum": 20, "unit": "cm"},
    "references.hanging_indent_chars": {"type": "number", "minimum": 0, "maximum": 20, "unit": "character"},
    ...
    "text.terminal_punctuation": {"type": "enum", "values": {"none", "period"}},
    ...
    "citation.allowed": {"type": "boolean"},
    "equation.wrap_before_operators": {"type": "string_list"},
    "equation.operator_at_line_start": {"type": "boolean"},
    "footnote.separator_width_percent": {"type": "number", "minimum": 0, "maximum": 100, "unit": "percent"},
